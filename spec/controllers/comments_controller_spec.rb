...
RSpec.describe CommentsController, type: :controller do
  let(:my_user) { User.create!(name: "Test User", email: "test@bloccit.com", password: "password") }
  ...
  #OTHER USER CONTEXT TESTS
  context "member user doing CRUD on a post or comment they don't own" do
    before do
  ...
  #USER CONTEXT TESTS
  context "member user doing CRUD on a post or comment they do own" do
    before do
  ...
  #ADMIN CONTEXT TESTS
  context "admin user doing CRUD on a post or comment they don't own" do
    before do
      other_user.admin!
      create_session(other_user)
    end
