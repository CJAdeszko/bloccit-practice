...
RSpec.describe PostsController, type: :controller do
  let(:my_user) { User.create!(name: "Test", email: "test@bloccit.com", password: "password") }
  let(:other_user) { User.create!(name: "Other User", email: "other@bloccit.com", password: "password") }
  ...
  #SIGNED IN OTHER USER SCOPE TESTS
  ...
  #SIGNED IN USER SCOPE TESTS
  context 'signed-in user doing CRUD on a post the own' do
    before do
